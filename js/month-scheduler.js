...
function getDatesBetween(date1,date2){
    ...
    // console.log(dates);
    let content = " <div class='calendarBtns'><button id='calenderPrev' onclick='callprev()' disabled>Prev</button>&nbsp; <button id='calenderNext' onclick='callnext()'>Next</button></div>";
    let weekDays = [{shortDay:"Mon",fullDay:"Monday"},
                    {shortDay:"Tue",fullDay:"Tuesday"},
                    {shortDay:"Wed",fullDay:"Wednesday"},
                    {shortDay:"Thu",fullDay:"Thursady"},
...
console.log(document.getElementsByClassName("calendarDiv"));